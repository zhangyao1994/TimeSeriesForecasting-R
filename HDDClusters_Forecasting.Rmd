---
title: "HDD Clusters Forecasting"
author: "Yao"
date: "May 30, 2018"
...
```{r Make 8 clusters according to the explorary analytics}
Cluster1 <- HDD_data %>% filter(Region %in% c('AMF','APJ') & Interface_All == 'SAS12G' & 
                      Capacity %in% c(1200,600,300,4000,2000,1000,8000,6000)) # High demand Capacity

Cluster2 <- HDD_data %>% filter(Region %in% c('AMF','APJ') & Interface_All == 'SAS12G' & 
                      !(Capacity %in% c(1200,600,300,4000,2000,1000,8000,6000))) # Low demand Capacity

Cluster3 <- HDD_data %>% filter(Region %in% c('AMF','APJ') & Interface_All == 'SATA6G' & 
                      Capacity %in% c(1200,600,300,4000,2000,1000,8000,6000))

Cluster4 <- HDD_data %>% filter(Region %in% c('AMF','APJ') & Interface_All == 'SATA6G' & 
                     !(Capacity %in% c(1200,600,300,4000,2000,1000,8000,6000)))

Cluster5 <- HDD_data %>% filter(Region == 'EMEA' & Interface_All == 'SAS12G' & 
                      Capacity %in% c(1200,600,300,4000,2000,1000,8000,6000))

Cluster6 <- HDD_data %>% filter(Region == 'EMEA' & Interface_All == 'SAS12G' & 
                       !(Capacity %in% c(1200,600,300,4000,2000,1000,8000,6000)))

Cluster7 <- HDD_data %>% filter(Region == 'EMEA' & Interface_All == 'SATA6G' & 
                      Capacity %in% c(1200,600,300,4000,2000,1000,8000,6000)) 

Cluster8 <- HDD_data %>% filter(Region == 'EMEA' & Interface_All == 'SATA6G' & 
                      !(Capacity %in% c(1200,600,300,4000,2000,1000,8000,6000)))
