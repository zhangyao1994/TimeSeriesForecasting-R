...
```{r set up Plotly}
library(plotly)
# Sys.setenv("plotly_username"="zhangyao1994")
# Sys.setenv("plotly_api_key"="HAeq9WWHFDV9mcxbBex9") # Does not work? Try this at home.
```

```{r Create a chart for visualization}
i=2
temp_data <- filter(CFG_fcast.joined,CFG==CFGgroups[i])# for certain CFG
