...
for(i in 1:(n-k-1))
{
  xshort <- window(HDDQuarterlytimeseries,start=StartYear+(i-1)/freq,end=2018+i/freq)
...
{
  xshort <- window(HDDMonthlytimeseries,start=StartYear+(i-1)/freq,end=StartYear+(i-1+k-1)/freq)
