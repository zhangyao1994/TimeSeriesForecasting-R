...
plot(1:3,colSums(mae3,na.rm=TRUE),type="l",col=4,xlab="horizon",ylab="MAE")
lines(1:3,colSums(mae2,na.rm=TRUE),type="l",col=3)
lines(1:3,colSums(mae1,na.rm=TRUE),type="l",col=2)
