...
write_feather(All_fcast,"~/Yao_Rdata/All_fcast_CV_Cal_Qtr.feather")
write_excel_csv(All_fcast,"~/Yao_Excels/All_fcast_CV_Cal_Qtr.csv")
```

```{r Error Calculation}
yao_hdd = readxl::read_excel('~/Yao_Excels/All_fcast_CV_Cal_Qtr.xlsx', na = 'NA')
...
write_excel_csv(EvalResults,"~/Yao_Excels/EvalResults.csv")
...
write_excel_csv(Error.w.Attributes,"~/Yao_Excels/Error_W_Attributes.csv")
```
