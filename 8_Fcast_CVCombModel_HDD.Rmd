...
indx <- c('MAPE_wk_Prophet','APE_FcastRegion_Prophet','MAPE_wk_ARIMA','APE_FcastRegion_ARIMA','MAPE_wk_TBATS','APE_FcastRegion_TBATS','MAPE_wk_lm','APE_FcastRegion_lm','MAPE_wk_RF','APE_FcastRegion_RF','MAPE_wk_Xgboost','APE_FcastRegion_Xgboost','MAPE_wk_Comb','APE_FcastRegion_Comb')
...
Eval.results_fcastRegion <- data.frame(Eval.results[,seq(2,14,2)])
dimnames(Eval.results_fcastRegion)[[2]] <- c('Prophet','ARIMA','TBATS','lm','RF','Xgboost','Comb')
...
Eval.results_fcastRegion[,1:7] <- lapply(Eval.results_fcastRegion[,1:7], function(x) as.numeric(as.character(x)))

Eval.results_wk <- data.frame(Eval.results[,seq(1,14,2)])
dimnames(Eval.results_wk)[[2]] <- c('Prophet','ARIMA','TBATS','lm','RF','Xgboost','Comb')
