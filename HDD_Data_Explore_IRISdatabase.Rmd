...
HDD_data %>% group_by(Fiscal_Wk) %>%
  ...
  filter(Fiscal_Wk>'FY17W09' & Fiscal_Wk<'FY19W16') -> temp_data

p_week <- temp_data %>%
  ggplot(aes(x=Fiscal_Wk,y=Fiscal_Wk_QTY,group=1)) +
  geom_point(size = 2) +
  geom_line(size = 1.5) +
  labs(title = 'Overall HDD Weekly Sales FY17W10-FY19W15', x = "Fiscal Week", y = "Part Quantity") + 
...
p_month <- temp_data %>%
  ...
  geom_point(size = 2) +
  geom_line(size = 1.5) +
  labs(title = 'HDD Monthly Sales FY17M04-FY19M03', x = "Fiscal Month", y = "Part Quantity") + 
  theme_minimal(base_size = 18) + 
  scale_color_tableau('tableau10medium') + 
...
p_quarter <- temp_data %>%
  ...
  labs(title = 'Overall HDD Quarterly Sales FY17Q2-FY19Q1', x = "Fiscal Quarter", y = "Part Quantity") + 
...
p_Monthly_RGN_DESC <- temp_data %>%
  ...
  geom_point(size = 2) +
  geom_line(size = 1.5) +
  labs(title = 'HDD Monthly Sales by Region FY17M04-FY19M03', x = "Fiscal Month", y = "Part Quantity") + 
  theme_minimal(base_size = 18) + 
  scale_color_tableau('tableau10medium') + 
  scale_x_discrete(breaks = c('FY17M04','FY18M01', 'FY19M01')) +
...
p_Quarterly_Region <- temp_data %>%
  ...
  geom_point(size = 2) +
  geom_line(size = 1.5) +
  labs(title = 'Overall HDD Quarterly Sales by Region FY17Q2-FY19Q1', x = "Fiscal Quarter", y = "Part Quantity") + 
  theme_minimal(base_size = 14) + 
  #scale_color_tableau('tableau10medium') + 
  #scale_x_discrete(breaks = c('FY17Q2', 'FY18Q1', 'FY19Q1')) +
  theme(legend.position = 'bottom',plot.title = element_text(hjust = 0.5))+
...
HDD_data %>%  filter(Fiscal_Qtr>'FY17Q1' & Fiscal_Qtr<'FY19Q2') %>%
  group_by(Customer) %>%
...
HDD_data %>% 
  ...
  filter(Fiscal_Qtr>'FY17Q1' & Fiscal_Qtr<'FY19Q2') %>%
...
p_Quarterly_Customer_LOB <- data4plot %>% 
  ...
  labs(title = 'Overall HDD Quarterly Sales by Customers and LOB FY17Q2-FY19Q1', x = "Fiscal Quarter", y = "Part Quantity") + 
  theme_minimal(base_size = 14) + 
  scale_color_tableau('tableau10medium') + 
  scale_x_discrete(breaks = c('FY17Q2', 'FY18Q1', 'FY19Q1')) +
  theme(legend.position = 'bottom',plot.title = element_text(hjust = 0.5))+
...
p_Monthly_LOB_DESC <- temp_data %>%
  ...
  geom_point(size = 2) +
  geom_line(size = 1.5) +
  labs(title = 'HDD Monthly Sales by LOB_DESC FY17M04-FY19M03', x = "Fiscal Month", y = "Part Quantity") + 
  theme_minimal(base_size = 18) + 
  scale_color_tableau('tableau10medium') + 
  scale_x_discrete(breaks = c('FY17M04','FY18M01', 'FY19M01')) +
  theme(legend.position = 'bottom',plot.title = element_text(hjust = 0.5))+
...
HDD_data %>% 
  ...
  filter(Fiscal_Qtr>'FY17Q1' & Fiscal_Qtr<'FY19Q2') -> temp_qtr

HDD_data %>% 
  group_by(CFG,Fiscal_Mo) %>%
  summarise(CFG_Fiscal_Mo_QTY=sum(PART_QTY)) %>%
  filter(Fiscal_Mo>'FY17M03' & Fiscal_Mo<'FY19M04') -> temp_mo

HDD_data %>% 
  group_by(CFG,Fiscal_Wk) %>%
  summarise(CFG_Fiscal_Wk_QTY=sum(PART_QTY)) %>%
  filter(Fiscal_Wk>'FY17W09' & Fiscal_Wk<'FY19W16') -> temp_wk
...
for (i in 1:len){
  ...
  geom_point(size = 2) +
  geom_line(size = 1.5) +
  labs(title = paste(CFGgroups[i],'HDD Weekly Sales FY17W10-FY19W15'), x = "Fiscal Week", y = "Part Quantity") + 
  theme_minimal(base_size = 14) + 
  scale_color_tableau('tableau10medium') + 
  scale_x_discrete(breaks = c('FY17W10', 'FY18W01', 'FY19W01')) +
  theme(legend.position = 'none',plot.title = element_text(hjust = 0.5)) +
  ...
  geom_point(size = 2) +
  geom_line(size = 1.5) +
  labs(title = paste(CFGgroups[i],'HDD Monthly Sales FY17M04-FY19M03'), x = "Fiscal Month", y = "Part Quantity") + 
  theme_minimal(base_size = 14) + 
  scale_color_tableau('tableau10medium') + 
  scale_x_discrete(breaks = c('FY17M04','FY18M01', 'FY19M01')) +
  theme(legend.position = 'none',plot.title = element_text(hjust = 0.5)) +
  ...
  geom_line(size = 1.5) +
  #geom_bar(stat = 'identity') +
  labs(title = paste(CFGgroups[i],'HDD Quarterly Sales FY17Q2-FY19Q1'), x = "Fiscal Quarter", y = "Part Quantity") + 
  theme_minimal(base_size = 14) + 
  scale_color_tableau('tableau10medium') + 
  theme(legend.position = 'none',plot.title = element_text(hjust = 0.5))+
  scale_y_continuous(label=comma) + expand_limits(y = 0)
